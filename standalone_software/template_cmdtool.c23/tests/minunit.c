...
void minunit_add_test(Minunit_tests_table *table,
                      void (*body)(Minunit_state *test_results),
                      void (*setup)(Minunit_state *test_results),
                      void (*teardown)(Minunit_state *test_results))
{
...
int minunit_run_table_callback(Minunit_tests_table *table,
                               Intra_test_callback callback)
{
